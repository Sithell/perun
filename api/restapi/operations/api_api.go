...
func NewAPIAPI(spec *loads.Document) *APIAPI {
	return &APIAPI{
		...
		GetJobByIDHandler: GetJobByIDHandlerFunc(func(params GetJobByIDParams) middleware.Responder {
			return middleware.NotImplemented("operation GetJobByID has not yet been implemented")
		}),
		GetJobStdoutHandler: GetJobStdoutHandlerFunc(func(params GetJobStdoutParams) middleware.Responder {
			return middleware.NotImplemented("operation GetJobStdout has not yet been implemented")
		}),
...
/*APIAPI Public Perun API for users */
type APIAPI struct {
	spec            *loads.Document
	...
	// GetJobByIDHandler sets the operation handler for the get job by ID operation
	GetJobByIDHandler GetJobByIDHandler
	// GetJobStdoutHandler sets the operation handler for the get job stdout operation
	GetJobStdoutHandler GetJobStdoutHandler
...
func (o *APIAPI) Validate() error {
	...
	if o.GetJobByIDHandler == nil {
		unregistered = append(unregistered, "GetJobByIDHandler")
	}
	if o.GetJobStdoutHandler == nil {
		unregistered = append(unregistered, "GetJobStdoutHandler")
	}
...
func (o *APIAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/jobs"] = NewCreateJob(o.context, o.CreateJobHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/jobs/{id}"] = NewGetJobByID(o.context, o.GetJobByIDHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/jobs/{id}/stdout"] = NewGetJobStdout(o.context, o.GetJobStdoutHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
